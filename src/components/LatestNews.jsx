    ...
    return (
        <section>
            <div className="tablewrap">
                ...
                <div className="wrap">
                    <div className="latest-news" data-aos="flip-left" data-aos-duration='2000'>
                    ...
                    <div className="latest-news" data-aos="flip-right" data-aos-duration='2000'>
                        <div className='headin'>
                            <h3>Appeal</h3>
                        </div>
                        <div className="contains">
                            <ul>
                                {appeals.map((appeal, index) => <li key={index}>{appeal.data}<button className='down-btn'><IoMdDownload />
                                </button></li>)}
                            </ul>
                        </div>
                        <div className='btn-wrap'>

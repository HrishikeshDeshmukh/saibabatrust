    ...
    return (
        <section>
            ...
            <div className="services">
                <p>Shri Saibaba Sansthan Trust, Shirdi is pleased to launch next generation portal for availing Darshan, Aarti, Donation, Accommodation, Pooja, Membership and Publications services. Please click on the below links to avail the services.</p>
